    ...
    case 'tree': // The Tree — a canopy reaching up over a hill, sun behind
      return (
        <>
          ...
          <g stroke="none">
            <ellipse className="na-leaf" cx="98" cy="116" rx="5" ry="3" fill={a} fillOpacity={0.55} />
            <ellipse className="na-leaf" cx="140" cy="108" rx="5" ry="3" fill={a} fillOpacity={0.5} style={{ animationDelay: '2.1s' }} />
            <ellipse className="na-leaf" cx="120" cy="122" rx="4" ry="2.5" fill={a} fillOpacity={0.45} style={{ animationDelay: '3.9s' }} />
          </g>
        </>
      );
    case 'sprout': // The Vine — a climber curling up a slender support
      return (
        <>
          ...
          <path className="na-grow" pathLength={1} d="M120 184 C150 168 96 150 124 128 C152 108 96 96 122 76" />
          <path className="na-leafin" d="M122 160 c-20 -8 -30 4 -28 16 c18 2 30 -4 28 -16 Z" fill={a} fillOpacity={0.18} />
          <path className="na-leafin" style={{ animationDelay: '0.5s' }} d="M124 128 c20 -10 30 2 30 14 c-18 4 -30 -2 -30 -14 Z" fill={a} fillOpacity={0.18} />
          <path className="na-leafin" style={{ animationDelay: '1s' }} d="M122 76 c14 -12 30 -6 32 4 c-14 12 -30 6 -32 -4 Z" fill={a} fillOpacity={0.2} />
        </>
      );
    case 'sun': // The Sun — high and radiant over low hills
      return (
        <>
          ...
          <circle className="na-breathe" cx="120" cy="104" r="40" fill={a} fillOpacity={0.18} />
          <g className="na-rays">
    ...
    case 'rock': // The Mountain — steady peaks with a high snowline
      return (
        <>
          ...
          <path className="na-glint" d="M88 110 l16 -26 l18 26 l-12 8 l-10 -8 Z" fill={a} fillOpacity={0.3} stroke="none" />
          <path className="na-glint" d="M168 126 l14 -22 l16 22 l-12 6 Z" fill={a} fillOpacity={0.3} stroke="none" style={{ animationDelay: '1.2s' }} />
          <path className="na-stone" d="M100 92 l7 3 l-2 7 l-7 -3 Z" fill={a} fillOpacity={0.55} stroke="none" />
        </>
      );
    case 'field': // The Field — tended rows ripening under a low sun
      return (
        <>
          <circle className="na-breathe" cx="180" cy="78" r="18" fill={a} fillOpacity={0.22} stroke="none" />
          ...
          {[70, 110, 150, 190].map((x, i) => (
            <path key={x} className="na-sproutgrow" style={{ animationDelay: `${i * 0.7}s` }} d={`M${x} 176 v-16 M${x} 160 l-7 -8 M${x} 162 l7 -8`} strokeWidth={2.2} strokeOpacity={0.8} />
          ))}
        </>
      );
    case 'sword': // The Blade — forged, upright, clean-edged
      return (
        <>
          ...
          <path className="na-glint" d="M120 52 L132 96 L130 168 L110 168 L108 96 Z" fill={a} fillOpacity={0.28} stroke="none" />
          <path d="M120 52 L132 96 L130 168 L110 168 L108 96 Z" />
          <path className="na-glint" d="M120 70 V160" strokeWidth={1.8} strokeOpacity={0.7} style={{ animationDelay: '0.6s' }} />
    ...
    case 'gem': // The Jewel — faceted, catching the light
      return (
        <>
          ...
          <path className="na-twinkle" d="M170 78 l4 -12 l4 12 l12 4 l-12 4 l-4 12 l-4 -12 l-12 -4 Z" fill={a} fillOpacity={0.3} stroke="none" />
          <path className="na-twinkle" d="M88 140 l3 -9 l3 9 l9 3 l-9 3 l-3 9 l-3 -9 l-9 -3 Z" fill={a} fillOpacity={0.25} stroke="none" style={{ animationDelay: '1.3s' }} />
        </>
      );
    case 'river': // The River — winding wide through a valley
      return (
        <>
          ...
          <path className="na-river" d="M96 56 C150 96 84 128 132 164 C160 186 120 210 150 236" strokeWidth={3} />
      ...
      return (
        <>
          ...
          {[84, 112, 140, 168].map((x, i) => (
            <path key={x} className="na-drop" style={{ animationDelay: `${i * 0.42}s` }} d={`M${x} ${150 + (i % 2) * 8} l-6 16`} strokeWidth={2.6} />
          ))}
